...
import styles from "./SkillsDetailsPOne.module.css";
...
interface SkillsDetailsPOneProps {}

const SkillsDetailsPOne = (props: SkillsDetailsPOneProps) => {
  return (
...
export default SkillsDetailsPOne;
