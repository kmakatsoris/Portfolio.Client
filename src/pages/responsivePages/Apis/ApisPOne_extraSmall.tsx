...
import styles from "./ApisPOne_extraSmall.module.css";
...
interface ApisPOne_extraSmallProps {}

const ApisPOne_extraSmall = (props: ApisPOne_extraSmallProps) => {
...
export default ApisPOne_extraSmall;
