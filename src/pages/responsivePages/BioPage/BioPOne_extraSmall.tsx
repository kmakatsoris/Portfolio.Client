...
import styles from "./BioPOne_extraSmall.module.css";
...
interface BioPOne_extraSmallProps {}

const BioPOne_extraSmall = (props: BioPOne_extraSmallProps) => {
...
export default BioPOne_extraSmall;
