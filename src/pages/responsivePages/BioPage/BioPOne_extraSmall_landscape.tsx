...
import styles from "./BioPOne_extraSmall_landscape.module.css";
...
interface BioPOne_extraSmall_landscapeProps {}

const BioPOne_extraSmall_landscape = (
  props: BioPOne_extraSmall_landscapeProps
) => {
        ...
        <ContentViewerPatch2
          ...
          content={
            <TitleAndContentViewer
              ...
              linehorizonalW={"100%"}
              fontSize="65%"
              marginTitle="7% 0px 10%"
              marginLine="-27px 0px 38px 0px"
              marginContent="0px 0px 10%"
            />
          }
          orientation={"column"}
          animationModes={[0, 1]}
...
export default BioPOne_extraSmall_landscape;
