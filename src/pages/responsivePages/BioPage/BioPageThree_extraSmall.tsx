...
import styles from "./BioPageThree_extraSmall.module.css";
...
interface BioPageThree_extraSmallProps {}

const BioPageThree_extraSmall = (props: BioPageThree_extraSmallProps) => {
        ...
        <ContentViewerPatch2
          graphic={
            <TitleAndContentViewer
              ...
              linehorizonalW={"100%"}
              fontSize="65%"
              marginTitle="-11% 0px 12%"
              marginLine="-26px 0px -3px"
...
export default BioPageThree_extraSmall;
