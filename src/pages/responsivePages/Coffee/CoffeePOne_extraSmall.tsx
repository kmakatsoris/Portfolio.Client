...
import styles from "./CoffeePOne_extraSmall.module.css";
...
interface CoffeePOne_extraSmallProps {
  insidePageRefs: React.RefObject<HTMLDivElement>[];
}

const CoffeePOne_extraSmall = (props: CoffeePOne_extraSmallProps) => {
...
export default CoffeePOne_extraSmall;
