...
import styles from "./CoffeePThree_extraSmall.module.css";
...
interface CoffeePThree_extraSmallProps {
  currentPath: string;
}

const CoffeePThree_extraSmall = (props: CoffeePThree_extraSmallProps) => {
  const {
    setCurrentPathname,
...
export default CoffeePThree_extraSmall;
