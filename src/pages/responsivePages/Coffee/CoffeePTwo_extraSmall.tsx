...
import styles from "./CoffeePTwo_extraSmall.module.css";
...
interface CoffeePTwo_extraSmallProps {}

const CoffeePTwo_extraSmall = (props: CoffeePTwo_extraSmallProps) => {
...
export default CoffeePTwo_extraSmall;
