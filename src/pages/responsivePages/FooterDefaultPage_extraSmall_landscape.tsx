...
import styles from "./FooterDefaultPage_extraSmall_landscape.module.css";
...
interface FooterDefaultPage_extraSmall_landscapeProps {}

const FooterDefaultPage_extraSmall_landscape = (
  props: FooterDefaultPage_extraSmall_landscapeProps
) => {
...
export default FooterDefaultPage_extraSmall_landscape;
