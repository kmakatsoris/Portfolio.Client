...
import styles from "./HomePagePEight_extraSmall_landscape.module.css";
...
interface HomePagePEight_extraSmall_landscapeProps {}

const HomePagePEight_extraSmall_landscape = (
  props: HomePagePEight_extraSmall_landscapeProps
) => {
...
export default HomePagePEight_extraSmall_landscape;
