...
import styles from "./HomePagePFive_extraSmall.module.css";
...
interface HomePagePFive_extraSmallProps {}

const HomePagePFive_extraSmall = (props: HomePagePFive_extraSmallProps) => {
        ...
        <ContentViewerPatch2
          graphic={
            <TitleAndContentViewer
              ...
              linehorizonalW={"100%"}
              fontSize="65%"
              marginTitle="-5% 0px 2% 0px"
              marginLine="0px 0px 5% 0px"
              marginContent="0px 0px 5% 0px"
            />
          }
          content={
...
export default HomePagePFive_extraSmall;
