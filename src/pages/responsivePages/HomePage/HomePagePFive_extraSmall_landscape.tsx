...
import styles from "./HomePagePFive_extraSmall_landscape.module.css";
...
interface HomePagePFive_extraSmall_landscapeProps {}

const HomePagePFive_extraSmall_landscape = (
  props: HomePagePFive_extraSmall_landscapeProps
) => {
              ...
              content={
                <div className={styles.textsContainer}>
                  <div className={styles.text1Container}>
                    <span className={styles.textFocus}></span>Here, I'm thrilled
                    to
                  ...
                  <div className={styles.text2Container}>
                    <span className={styles.textFocus}></span>In addition to my
                    skills, this section highlights some of my notable
                    achievements and accomplishments. From successful projects
                    and innovative solutions to recognition and awards, each
                    achievement reflects my dedication to excellence and my
...
export default HomePagePFive_extraSmall_landscape;
