...
import styles from "./HomePagePFour_extraSmall.module.css";
...
interface HomePagePFour_extraSmallProps {}

const HomePagePFour_extraSmall = (props: HomePagePFour_extraSmallProps) => {
        ...
        <ContentViewerPatch2
          ...
          content={
            <TitleAndContentViewer
              ...
              linehorizonalW={"100%"}
              fontSize={"65%"}
              marginTitle="20px 0px 5px 0px"
              marginLine="0px 0px -4px 0px"
            />
          }
          orientation={"column"}
          animationModes={[0, 1]}
...
export default HomePagePFour_extraSmall;
