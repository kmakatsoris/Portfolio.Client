...
import styles from "./HomePagePFour_extraSmall_landscape.module.css";
...
interface HomePagePFour_extraSmall_landscapeProps {}

const HomePagePFour_extraSmall_landscape = (
  props: HomePagePFour_extraSmall_landscapeProps
) => {
...
export default HomePagePFour_extraSmall_landscape;
