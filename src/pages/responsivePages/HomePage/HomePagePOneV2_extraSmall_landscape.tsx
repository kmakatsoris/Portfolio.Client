...
import styles from "./HomePagePOneV2_extraSmall_landscape.module.css";
...
interface HomePagePOneV2_extraSmall_landscapeProps {}

const HomePagePOneV2_extraSmall_landscape = (
  props: HomePagePOneV2_extraSmall_landscapeProps
) => {
...
export default HomePagePOneV2_extraSmall_landscape;
