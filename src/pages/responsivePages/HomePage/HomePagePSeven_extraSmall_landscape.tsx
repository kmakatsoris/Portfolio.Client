...
import styles from "./HomePagePSeven_extraSmall_landscape.module.css";
...
interface HomePagePSeven_extraSmall_landscapeProps {}

const HomePagePSeven_extraSmall_landscape = (
  props: HomePagePSeven_extraSmall_landscapeProps
) => {
        ...
        <ContentViewerPatch2
          graphic={
            <TitleAndContentViewer
              ...
              linehorizonalW={"100%"}
              fontSize="65%"
              marginTitle="-2.5% 0px 1%"
              marginLine="0% 0px 0%"
              marginContent="1% 0px 0%"
            />
          }
          content={
...
export default HomePagePSeven_extraSmall_landscape;
