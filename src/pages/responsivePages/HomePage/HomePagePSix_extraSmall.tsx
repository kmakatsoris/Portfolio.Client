...
import styles from "./HomePagePSix_extraSmall.module.css";
...
interface HomePagePSix_extraSmallProps {}

const HomePagePSix_extraSmall = (props: HomePagePSix_extraSmallProps) => {
...
export default HomePagePSix_extraSmall;
