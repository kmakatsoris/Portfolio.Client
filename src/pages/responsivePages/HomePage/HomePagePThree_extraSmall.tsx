...
import styles from "./HomePagePThree_extraSmall.module.css";
...
interface HomePagePThree_extraSmallProps {}

const HomePagePThree_extraSmall = (props: HomePagePThree_extraSmallProps) => {
        ...
        <ContentViewerPatch2
          graphic={
            <TitleAndContentViewer
              ...
              linehorizonalW={"100%"}
              fontSize="65%"
              marginTitle="-20% 0px 5px 0px"
              marginLine="0px 0px 0px 0px"
              marginContent="0px 0px -16px 0px"
            />
          }
          content={
...
export default HomePagePThree_extraSmall;
