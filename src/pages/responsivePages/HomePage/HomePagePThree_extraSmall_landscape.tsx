...
import styles from "./HomePagePThree_extraSmall_landscape.module.css";
...
interface HomePagePThree_extraSmall_landscapeProps {}

const HomePagePThree_extraSmall_landscape = (
  props: HomePagePThree_extraSmall_landscapeProps
) => {
...
export default HomePagePThree_extraSmall_landscape;
