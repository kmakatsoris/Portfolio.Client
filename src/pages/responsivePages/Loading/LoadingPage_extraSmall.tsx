...
import styles from "./LoadingPage_extraSmall.module.css";
...
const TIME_INTERVAL_TO_ANIMATED_SHAPES: number = 300;
...
interface LoadingPage_extraSmallProps {
  isLoaded: React.Dispatch<React.SetStateAction<boolean>>;
  enQuotes: boolean;
  enShapes: boolean;
}

const LoadingPage_extraSmall = (props: LoadingPage_extraSmallProps) => {
      ...
      <InfiniteRender
        renderComponent={
          <div
            ...
            style={{ top: "calc(60% - 350px)", left: "-50%" }}
          >
            <CodeDisplay
              codes={codeExamples}
              interval={100}
...
export default LoadingPage_extraSmall;
