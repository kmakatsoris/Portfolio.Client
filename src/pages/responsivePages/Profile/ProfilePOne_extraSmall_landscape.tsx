...
import styles from "./ProfilePOne_extraSmall_landscape.module.css";
...
interface ProfilePOne_extraSmall_landscapeProps {}

const ProfilePOne_extraSmall_landscape = (
  props: ProfilePOne_extraSmall_landscapeProps
) => {
            ...
            <MetaDataViewerScheduler
              defaultComponent={
                <div className={styles.backgroundImgContainer}>
                  <RenderWithDelay
                    key={`ProfilePOne_extraSmall_landscape_backgroundImgLabel1_${isRegister}`}
                    content={
                      <div
                        className={styles.backgroundImgLabel1}
                        onClick={isRegisterHandler}
                      >
                        {isRegister ? "Sign In" : "Register"}
                      </div>
                    }
                    interval={isRegister !== null ? 0 : 2000}
                    mode={2}
                    transitionDistance={"100%"}
                  />
                  <RenderWithDelay
                    key={`ProfilePOne_extraSmall_landscape_backgroundImgLabel2_${isRegister}`}
                    content={
                      <div
                        className={styles.backgroundImgLabel2}
                        onClick={isRegisterHandler}
                      >
                        {isRegister ? "Sign In" : "Register"}
                      </div>
                    }
                    interval={isRegister !== null ? 400 : 2400}
                    mode={2}
                    transitionDistance={"100%"}
                  />
                  <RenderWithDelay
                    key={`ProfilePOne_extraSmall_landscape_backgroundImgLabel3_${isRegister}`}
                    content={
                      <div
                        className={styles.backgroundImgLabel3}
                        onClick={isRegisterHandler}
                      >
                        {isRegister ? "Sign In" : "Register"}
                      </div>
                    }
                    interval={isRegister !== null ? 800 : 2800}
                    mode={2}
                    transitionDistance={"100%"}
                  />
                  <RenderWithDelay
                    key={`ProfilePOne_extraSmall_landscape_backgroundImgLabel4_${isRegister}`}
                    content={
                      <div
                        className={styles.backgroundImgLabel4}
                        onClick={isRegisterHandler}
                      >
                        {isRegister ? "Sign In" : "Register"}
                      </div>
                    }
                    interval={isRegister !== null ? 1300 : 3300}
                    mode={2}
                    transitionDistance={"100%"}
                  />
                  <RenderWithDelay
                    key={`ProfilePOne_extraSmall_landscape_backgroundImgLabel5_${isRegister}`}
                    content={
                      <div
                        className={styles.backgroundImgLabel5}
                        onClick={isRegisterHandler}
                      >
                        {isRegister ? "Sign In" : "Register"}
                      </div>
                    }
                    interval={isRegister !== null ? 1600 : 3600}
                    mode={2}
                    transitionDistance={"100%"}
                  />
                  <img
...
export default ProfilePOne_extraSmall_landscape;
