...
import styles from "./SkillsPOne_extraSmall_landscape.module.css";
...
interface SkillsPOne_extraSmall_landscapeProps {
  insidePageRefs: React.RefObject<HTMLDivElement>[];
}

const SkillsPOne_extraSmall_landscape = (
  props: SkillsPOne_extraSmall_landscapeProps
) => {
...
export default SkillsPOne_extraSmall_landscape;
