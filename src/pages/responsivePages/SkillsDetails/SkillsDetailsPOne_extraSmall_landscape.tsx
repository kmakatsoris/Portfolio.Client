...
import styles from "./SkillsDetailsPOne_extraSmall_landscape.module.css";
...
interface SkillsDetailsPOne_extraSmall_landscapeProps {}

const SkillsDetailsPOne_extraSmall_landscape = (
  props: SkillsDetailsPOne_extraSmall_landscapeProps
) => {
  return (
...
export default SkillsDetailsPOne_extraSmall_landscape;
